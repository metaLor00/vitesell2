...
- Add toJSON transforms to remove internal fields (_id to id, hide __v, passwords).
...
- Model: User schema with email (unique, indexed), password (select: false), timestamps, toJSON transform hiding password and __v.
